.. image:: https://travis-ci.org/bgschiller/thinkcspy.svg?branch=master
...
2. You can build it and host it yourself in just a few simple steps:
    ...
    3.  ``pipenv run runestone build`` -- will build the html and put it in ``./build/thinkcspy``
    4.  ``pipenv run runestone serve``   -- will start a webserver and serve the pages locally from ``./build/thinkcspy``
