...
In order to better understand the rest of this chapter's content, let's examine objects and references. We introduced them at the beginning of the unit in the `lesson on variables </SimplePythonData/Variables.html>`_, but now we'll look at them in more detail with regard to strings and lists.
